...
class UNet_Down(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.inc = DownHead(n_channels, 64)
        self.down1 = DownConv(64, 128)
        self.down2 = DownConv(128, 256)
        self.down3 = DownConv(256, 512)
        factor = 2 if bilinear else 1
        self.down4 = DownConv(512, 1024 // factor)
        self.up1 = UpRes(1024, 512 // factor)
        self.up2 = UpRes(512, 256 // factor)
        self.up3 = UpRes(256, 128 // factor)
...
class UNet_fp4(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
        ...
        self.down1 = DownConv(64, 128)
        self.down2 = DownConv(128, 256)
        self.cen = nn.Sequential(ResBlock(256, 256), ResBlock(256, 512),
                                 ResBlock(512, 1024), ResBlock(1024, 512),
                                 ResBlock(512, 256), ResBlock(256, 256))
        factor = 2
        self.up1 = Up(256 + 128, 256 // factor)
        self.up2 = Up(128 + 64, 128 // factor)
        self.outc = nn.Sequential(DoubleConv(64, 32), OutConv(32, n_classes))
...
class UNet_fp16(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
        ...
        self.cen = nn.Sequential(ResBlock(512, 1024), ResBlock(1024, 1024),
                                 ResBlock(1024, 1024), ResBlock(1024, 512),
