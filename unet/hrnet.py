...
class hrnet48_p1(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(hrnet48_p1, self).__init__()
        ...
        # contect trans
        self.conTrans2_1=UpBlock(128, 128)
        self.conTrans3_2=UpBlock(256, 256)
        self.conTrans4_3=UpBlock(512, 512)

        # feature cat layer
        # self.catLayer3=ResBlock(512+256,256)
        # self.catLayer2=ResBlock(128+256,128)
        # self.catLayer1=ResBlock(128+64,64)

        self.catLayer3=ResBlock(512+256+256,256)
        self.catLayer2=ResBlock(128+256+128,128)
        self.catLayer1=ResBlock(128+64+64,64)
    ...
    def forward(self,x):
        ...
        # connect fusion
        # x3_hrnet=self.fusion_cat(self.conTrans4_3(x4_fus),x3_fus)
        # x3_hrnet=self.catLayer3(x3_hrnet)

        # x2_hrnet=self.fusion_cat(self.conTrans3_2(x3_hrnet),x2_fus)
        # x2_hrnet=self.catLayer2(x2_hrnet)

        # x1_hrnet=self.fusion_cat(self.conTrans2_1(x2_hrnet),x1_fus)
        # x1_hrnet=self.catLayer1(x1_hrnet)

        x3_hrnet=self.fusion_cat(self.conTrans4_3(x4_fus),x3_fus)
        x3_hrnet=self.fusion_cat(x3_hrnet, x3_s3)
        x3_hrnet=self.catLayer3(x3_hrnet)

        x2_hrnet=self.fusion_cat(self.conTrans3_2(x3_hrnet),x2_fus)
        x2_hrnet=self.fusion_cat(x2_s2, x2_hrnet)
        x2_hrnet=self.catLayer2(x2_hrnet)

        x1_hrnet=self.fusion_cat(self.conTrans2_1(x2_hrnet),x1_fus)
        x1_hrnet=self.fusion_cat(x1_s1, x1_hrnet)
        x1_hrnet=self.catLayer1(x1_hrnet)
